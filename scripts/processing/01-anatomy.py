...
from scripts.processing.library.config import study_path, subjects_dir, N_JOBS, spacing, exclude_subjects
...
#parallel(run_func(subject_id) for subject_id in range(5, 20))

parallel(run_func(subject_id=8))

# subject_id=1
# while subject_id < 20:
#     if subject_id not in exclude_subjects:
#         print("---------------------------------------------------- GOOD: ", subject_id)
#         parallel(run_func(subject_id))
#         subject_id+=1
#     else:
